...
import 'package:github_client/src/exception/GithubLoginException.dart';
        ...
        child: ElevatedButton(
          onPressed: () async {
            ...
            var authenticatedHttpClient = await _getOAuth2Client(
                Uri.parse("http://localhost:${_redirectServer!.port}/oauth2"));
  ...
  Future<oauth2.Client> _getOAuth2Client(Uri redirectUrl) async {
    if (widget.githubClientId.isEmpty || widget.githubClientSecret.isEmpty) {
      throw const GitHubLoginException(
          "Github client id and secret must be set");
    }
    ...
    var authorizationUrl = grant.getAuthorizationUrl(
        redirectUrl, scopes: widget.githubScopes);
